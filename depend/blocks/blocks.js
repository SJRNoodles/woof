...
function value_set() {
	var user_string_name = document.getElementById('bjsinput_name').value;
...
function value_set2() {
	var user_string_name = document.getElementById('bjsinput_name2').value;
...
function inner_set(varia, div) {
	...
	document.getElementById("bjsfunction").innerHTML = "<button onclick='addcode(" + '"' + evalname + "();" + '"' + "," + '"' + "block" + '"' + ");'>call function</button>";
